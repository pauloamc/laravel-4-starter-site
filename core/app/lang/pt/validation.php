...
return array(
    ...
    */
    ...
    "image"            => "O ficheiro deverá ser uma imagem.",
    "in"               => "O campo :attribute não contém um valor válido.",
    "integer"          => "O campo :attribute deverá conter um número inteiro.",
    "ip"               => "O campo :attribute deverá conter um IP válido.",
    "max"              => array(
        "numeric" => "O campo :attribute não deverá conter um valor superior a :max.",
        "file"    => "O tamanho do ficheiro não deverá ser superior a :max kilobytes.",
        "string"  => "O campo :attribute não deverá conter mais de :max carateres.",
        "array"   => "O campo :attribute não deverá conter mais de :max items."
    ),
    ...
    "size"             => array(
        ...
        "array"   => "O campo :attribute deverá conter :size items."
    ),
